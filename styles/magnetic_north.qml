...
<qgis version="3.16.4-Hannover" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|MapTips" labelsEnabled="0">
  <flags>
    ...
    <symbols>
      <symbol name="0" clip_to_extent="1" alpha="1" force_rhr="0" type="line">
        <layer pass="0" locked="0" enabled="1" class="SimpleLine">
          ...
          <prop k="line_color" v="192,0,0,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" blendMode="0" isExpression="1" textOpacity="1" fontLetterSpacing="0" fieldName="format_number(variation,2)" fontFamily=".AppleSystemUIFont" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" fontStrikeout="0" fontUnderline="0" multilineHeight="1" allowHtml="0" useSubstitutions="0" fontSizeUnit="Point" namedStyle="Regular" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontSize="10" fontWeight="50" textOrientation="horizontal" capitalization="0" fontWordSpacing="0">
        <text-buffer bufferColor="255,255,255,255" bufferJoinStyle="128" bufferNoFill="1" bufferSize="1" bufferSizeUnits="MM" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferOpacity="1"/>
      ...
      <text-format wrapChar="" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" formatNumbers="0" placeDirectionSymbol="0" plussign="0" autoWrapLength="0" multilineAlign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" decimals="3"/>
      <placement distMapUnitScale="3x:0,0,0,0,0,0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" overrunDistance="0" geometryGenerator="" geometryGeneratorType="PointGeometry" yOffset="0" rotationAngle="0" repeatDistance="0" placementFlags="10" overrunDistanceUnit="MM" lineAnchorPercent="0" preserveRotation="1" maxCurvedCharAngleIn="25" priority="5" repeatDistanceUnits="MM" placement="2" offsetUnits="MM" offsetType="0" xOffset="0" maxCurvedCharAngleOut="-25" quadOffset="4" distUnits="MM" polygonPlacementFlags="2" layerType="LineGeometry" centroidWhole="0" lineAnchorType="1" geometryGeneratorEnabled="0" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering labelPerPart="0" mergeLines="0" upsidedownLabels="0" fontMinPixelSize="3" minFeatureSize="0" scaleMax="2000000" maxNumLabels="2000" drawLabels="1" limitNumLabels="0" scaleMin="0" displayAll="0" scaleVisibility="1" obstacle="1" obstacleFactor="1" obstacleType="1" zIndex="0" fontMaxPixelSize="10000" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" value="" type="QString"/>
          <Option name="properties"/>
  ...
  <previewExpression>format_number(variation,2)</previewExpression>
  <mapTip></mapTip>
